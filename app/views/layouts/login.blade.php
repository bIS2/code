...
@section('main')
	...
	<div class="jumbotron" <?php if (strpos(Request::url(),'bistest.trialog.ch') !== false) { echo ' style="background-color: blue; border-color:blue;"'; } ?><?php if (strpos(Request::url(),'bisdev.trialog.ch') !== false) { echo ' style="background-color: green; border-color:green;"'; } ?>>
		<div class="container">
			<div class="lang">
