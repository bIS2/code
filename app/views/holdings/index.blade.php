	...
	<tr class="panel">
		<td>
		  <div class="panel-heading">
		      <h4 href="#a1c<?php echo $i; ?>" data-parent="#group-xx" data-toggle="collapse" class="accordion-toggle collapsed" style="width: 240px; display: inline-block;"><?php echo $hos[ $post->holgroups_id - 1]['sys1']; ?>
		      <h4 href="#a1c<?php echo $i; ?>" data-parent="#group-xx" data-toggle="collapse" class="accordion-toggle collapsed" style="display: inline-block;"><?php echo $hos[ $post->holgroups_id - 1]['f245a']; ?></h4>
		  </div>
