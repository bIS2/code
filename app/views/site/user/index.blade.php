...
<div class="row">
	...
	<div class="col-xs-4">
		<div class="page-header">
			<h3>{{{ trans('admin/users/title.user_update')}}}/{{{ trans('admin/users/title.create_a_new_user')}}}</h3>
		</div>
		...
		<!-- <form class="form-horizontal" method="post" action="{{ URL::to('user/' . $user->id . '/edit') }}"  autocomplete="off"> -->
		    ...
		    <div class="tab-pane active" id="tab-general">
		        ...
		        <div class="form-group {{{ $errors->has('username') ? 'error' : '' }}}">
		            <label class="col-md-4 control-label" for="username">{{ trans('general.username') }}</label>
		            <div class="col-md-8">
		        ...
		        <div class="form-group {{{ $errors->has('name') ? 'error' : '' }}}">
		            <label class="col-md-4 control-label" for="name">{{ trans('general.name') }}</label>
		            <div class="col-md-8">
		        ...
		        <div class="form-group {{{ $errors->has('lastname') ? 'error' : '' }}}">
		            <label class="col-md-4 control-label" for="lastname">{{ trans('general.lastname') }}</label>
		            <div class="col-md-8">
		        ...
		        <div class="form-group {{{ $errors->has('email') ? 'error' : '' }}}">
		            <label class="col-md-4 control-label" for="email">{{ trans('general.email') }}</label>
		            <div class="col-md-8">
		        ...
		        <div class="form-group {{{ $errors->has('password') ? 'error' : '' }}}">
		            <label class="col-md-4 control-label" for="password">{{ trans('general.password') }}</label>
		            <div class="col-md-8">
		        ...
		        <div class="form-group {{{ $errors->has('password_confirmation') ? 'error' : '' }}}">
		            <label class="col-md-4 control-label" for="password_confirmation">{{ trans('general.password_confirm') }}</label>
		            <div class="col-md-8">
