...
<ul id="groups-tabs" class="nav nav-tabs">
	...
	<form method="post" action="{{ route('sets.index', Input::except(['noexists'])) }}" id="profiles-form" ajax-post="{{ route('sets.index') }}?onlyprofiles=1">
		...
		<div id="hos_actions_and_filters" class="clearfix">
			...
			<a id="join-the-hos" class="btn btn-md btn-warning pull-left disabled" href="{{ action('HoldingssetsController@putJoinhos',[1]) }}" data-params="" data-disable-with="..." data-content="{{ trans('holdingssets.join_HOS'); }}"><i class="fa fa-magnet"></i></a>
