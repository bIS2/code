   ...
   /**
	...
	public function Index()
	{
		...
		/* SHOW/HIDE FIELDS IN HOLDINGS TABLES DECLARATION
			-----------------------------------------------------------*/
			define('DEFAULTS_FIELDS', 'sys2;008x;size;ocrr_ptrn;022a;072a;245a;245b;245n;245p;362a;852b;852h;852h_e;866a;866z;years;exists_online;is_current;has_incomplete_vols');
			define('ALL_FIELDS',      'sys2;008x;size;ocrr_ptrn;022a;072a;245a;245b;245n;245p;246a;260a;260b;310a;362a;505a;710a;770t;772t;780t;785t;852b;852c;852h;852h_e;852j;866a;866z;years;exists_online;is_current;has_incomplete_vols');
		...
		$this->data['allsearchablefields'] = ['sys2','008x','022a','245a','245b','245c','246a','245n','245p','260a','260b','300a','300b','300c','310a','362a','500a','505a','710a','770t','772t','780t','785t','852b','852c','852h','852h_e','852j','866a','866z','size' , 'weight', 'exists_online', 'is_current', 'has_incomplete_vols'];
    ...
    $this->data['is_all'] = !(Input::has('corrects') || Input::has('tagged') || Input::has('pendings') || Input::has('unlist') || Input::has('owner') || Input::has('aux')|| Input::has('deliveries') );
		...
		if ( Input::has('state') )			$holdings = Holding::inLibrary()->ownerOrAux()->withState( Input::get('state') );
